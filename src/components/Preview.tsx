...
export default function Preview() {
    ...
    return <Flex style={{ position: "static", width: "100%", gap: "1rem"}}>
                ...
                <Flex style={{
                        ...
                        Font Size:
                        <TextInput type="number" max="100" placeholder="60" value={fontSize} onChange={(e: { target: { value: number; }; }) =>  {
                            console.log(e.target.value);
                            setFontSize(e.target.value);
                        }} />
                </Flex>
                {imageUrl && <Flex style={{ gap: "1rem", height: "60vh", width: `${small ? 100: 50}%` }}>
                            <Image
                              src={imageUrl}
